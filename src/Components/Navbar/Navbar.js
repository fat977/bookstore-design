...
export const Navbar = () => {
  ...
  return (
    <nav
      ...
      className={
        scrolled
          ? "scrolled bg-light navbar fixed container-fluid d-flex justify-content-around stickyTop align-items-center my-5 py-4 shadow"
          : "container-fluid navbar d-flex justify-content-around align-items-center my-5"
      }
    >
      {/* logo with offcanvas */}
      <>
      ...
      {/* search on sm screen */}
      <i
        className="fa-solid fa-magnifying-glass d-block d-md-none"
      ...
      <div className="icons">
        ...
        <div className="dropdown-menu me-0 ms-auto p-3">
          <form action="#" id="login-form">
            ...
            <button type="submit" className="btn-login d-block w-100">
              SIGN IN
            </button>
            <p
              className="text-center register mt-3"
              onClick={form}
          ...
          <form action="#" className="d-none" id="register-form">
            ...
            <button type="submit" className="btn-register d-block w-100">
              Register
            </button>
            <p className="text-center login mt-3" id="login-form-link">
        ...
        >
          ...
          <span className="position-absolute top-0  translate-middle badge rounded-pill bg-warning">
            1
          </span>
        </span>
      </div>
      ...
      >
        ...
        <div className="mx-3 cart-buttons mb-4 mt-2">
          ...
          <button type="button" className="float-end">Buy Now</button>
        </div>
      </div>
    </nav>
  );
