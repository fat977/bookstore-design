        ...
        <section className="best-selling">
            <div className="container">
                <div className="row">
                    ...
                    <Carousel responsive={responsive} arrows={false} showDots={true} renderDotsOutside={true} autoPlay={true} infinite={true} className="owl-carousel owl-theme best-selling-slider">
                    {items.map((elem) => {
